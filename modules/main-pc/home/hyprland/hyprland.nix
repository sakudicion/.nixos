...

{
	...
	wayland.windowManager.hyprland = {
	      ...
	      settings = {
	        ...
	        "$terminal" = "kitty";
	        "$fileManager" = "thunar";
	        "$menu" = "rofi -config ~/.nixos/modules/main-pc/home/hyprland/rice/rofi/config.rasi -show drun";
		...
		cursor = {
	        ...
	        exec-once = [
	          ...
	          "swww-daemon &"
		  "swww img ~/.nixos/modules/main-pc/home/hyprland/rice/wallpapers/2.jpg &"
		  "ags -c ~/.nixos/modules/main-pc/home/hyprland/rice/ags/ &"
		];
